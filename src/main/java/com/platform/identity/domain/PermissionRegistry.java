...
public class PermissionRegistry {
    private static final Map<String, Set<String>> ROLE_PERMISSIONS = Map.of(
            ...
            "ROLE_AGENT",    Set.of("ACCIDENT_REPORT_VIEW_ALL", "CASE_REVIEW_LOCK", "CASE_REVIEW_VERIFY", "ASSET_VIEW","POLICY_VERIFY","POLICY_VIEW_QUEUE"),
            "ROLE_ADMIN",    Set.of("USER_MANAGEMENT", "SYSTEM_AUDIT_VIEW","ACCIDENT_REPORT_VIEW_ALL", "CASE_REVIEW_LOCK", "CASE_REVIEW_VERIFY", "ASSET_VIEW","POLICY_VERIFY","POLICY_VIEW_QUEUE")
    );
